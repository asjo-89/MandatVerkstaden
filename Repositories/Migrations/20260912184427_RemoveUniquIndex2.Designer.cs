...
namespace Repositories.Migrations
{
    ...
    [Migration("20260912184427_RemoveUniquIndex2")]
    partial class RemoveUniquIndex2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repositories.Entities.OriginalBoardSeatAllocation", b =>
                {
                    ...
                    b.Property<int>("LotDrawingGroupId")
                        .HasColumnType("int");

                    b.Property<int>("OriginalBoardSeatAllocationSetId")
                        .HasColumnType("int");

                    b.Property<int>("PoliticalPartyId")
                        .HasColumnType("int");

                    b.Property<int>("SeatAllocationStep")
                        .HasColumnType("int");

                    b.Property<bool>("WonByLotDrawing")
                        .HasColumnType("bit");

                    b.Property<bool>("WonSeat")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Repositories.Entities.OriginalCouncilSeatAllocation", b =>
                {
                    ...
                    b.Property<int>("TotalCouncilSeatCountForParty")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repositories.Entities.OriginalBoardSeatAllocation", b =>
                {
                    b.HasOne("Repositories.Entities.OriginalBoardSeatAllocationSet", "OriginalBoardSeatAllocationSet")
                        .WithMany("OriginalBoardSeatAllocations")
                        .HasForeignKey("OriginalBoardSeatAllocationSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("OriginalBoardSeatAllocationSet");
            ...
            modelBuilder.Entity("Repositories.Entities.OriginalBoardSeatAllocationSet", b =>
                {
                    b.HasOne("Repositories.Entities.OriginalElectionResultSet", "OriginalElectionResultSet")
                        .WithOne("OriginalBoardSeatAllocationSet")
                        .HasForeignKey("Repositories.Entities.OriginalBoardSeatAllocationSet", "OriginalElectionResultSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Repositories.Entities.OriginalBoardSeatAllocationSet", b =>
                {
                    b.Navigation("OriginalBoardSeatAllocations");
                });
